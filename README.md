...
[![Spec: 177 scenarios / 71 req](https://img.shields.io/badge/spec-158%20scenarios%20%2F%2063%20req-green.svg)](openspec/)
...
- Single-page React UI: decision tree, full-prompt inspection, fork interaction, branch diff (side-by-side, field-level), live debug toolbar, trace management (delete with cascade).
